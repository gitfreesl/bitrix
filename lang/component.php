...
$MESS ['MF_REQ_TEL'] = "Укажите ваш телефон.";
$MESS ['MF_REQ_TO'] = "Укажите, кому написать.";
$MESS ['MF_TEL_NOT_VALID'] = "Телефонный номер заполнен частично.";
$MESS ['MF_REQ_TOPIC'] = "Укажите тему письма.";
