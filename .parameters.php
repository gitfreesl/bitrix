...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"REQUIRED_FIELDS" => Array(
			...
			"TYPE"=>"LIST", 
			"MULTIPLE"=>"Y", 
			"VALUES" => Array("NONE" => GetMessage("MFP_ALL_REQ"), "NAME" => GetMessage("MFP_NAME"), "EMAIL" => "E-mail", "MESSAGE" => GetMessage("MFP_MESSAGE"),"TEL" => GetMessage("MFP_TEL"),"TOPIC" => GetMessage("MFP_TOPIC"),"TO" => GetMessage("MFP_TO")),
			"DEFAULT"=>"", 
			"COLS"=>25, 
			"PARENT" => "BASE",
		),
